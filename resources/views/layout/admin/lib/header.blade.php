    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="navbar-header d-flex align-items-center">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="{{ asset('asset/back/img/logo.png')}}" class="img-fluid logo-desktop" alt="logo" />
                <img src="{{ asset('asset/back/img/logo-icon.png')}}" class="img-fluid logo-mobile" alt="logo" />
            </a>
        </div>
                ...
                <ul class="navbar-nav nav-right ml-auto">
                                    ...
                                    <ul class="scrollbar scroll_dark max-h-240">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid" src="{{ asset('asset/back/img/avtar/03.jpg')}}" alt="user3">
                                                    </div>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid" src="{{ asset('asset/back/img/avtar/01.jpg')}}" alt="user">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid" src="{{ asset('asset/back/img/avtar/02.jpg')}}" alt="user2">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid" src="{{ asset('asset/back/img/avtar/04.jpg')}}" alt="user4">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid" src="{{ asset('asset/back/img/avtar/05.jpg')}}" alt="user5">
                                                    </div>
                                                    <div class="notify-message">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <div class="notification d-flex flex-row align-items-center">
                                                    <div class="notify-icon bg-img align-self-center">
                                                        <img class="img-fluid" src="{{ asset('asset/back/img/avtar/06.jpg')}}" alt="user6">
                                                    </div>
                                                    <div class="notify-message">
                    ...
                    <li class="nav-item dropdown user-profile">
                        <a href="javascript:void(0)" class="nav-link dropdown-toggle " id="navbarDropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset('asset/back/img/avtar/02.jpg')}}" alt="avtar-img">
