@extends('layout.admin.admin') @section ('title','Category List') @section('content')
                    ...
                    <tbody>
                        ...
                        <td>{{ $category->name }}</td>
                            ...
                            <a href="{{ route('admin.category.edit',$category->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="{{ url('admin/category/delete',$category->id) }}" onclick="return(confirm('are you sure to delete?'))" class="btn btn-primary"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
